...
const CropScreenTwo = ({navigation, route}) => {
  ...
  const cropOptions = () => {
    ...
    const options = {
      ...
      cropOffsetY:
        videoHeight > height
          ? parseInt((videoHeight / height) * state.cordY)
          : parseInt((videoHeight / height) * state.cordY),
    };
  ...
  const addVideo = async () => {
    ...
    await axios
      ...
      .catch(error => {
        setState(prev => ({...prev, visible: false}));
        console.log('#. addVideo() error : ', error.response.data.message);
    ...
    <ImageBackground
      ...
      {state.visible ? (
        ...
        <View style={{flex: 1}}>
          {uploadedBy == 1 ? (
            ...
            <Video
              ...
              style={{
                ...
                height: width,
                backgroundColor: '#000000',
                marginTop: (height + StatusBar.currentHeight) / 2 - width / 2,
                alignSelf: 'center',
              }}
            />
          )}
          ...
          <View
            style={{flex: 1, position: 'absolute', justifyContent: 'center'}}>
            <Draggable
              minX={5}
              minY={65}
              maxX={width - 5}
              ...
              <View
                onLayout={event => {
                  ...
                  console.log(
                    'layoutx, layouty = ' + layout.x + ', ' + layout.y,
                  );
                }}
                style={{
                  width: width - 10,
